...
class TradingViewChartService
{
    ...
    public function getChartData($startTime,$endTime, $interval, $baseCoinId, $tradeCoinId){


        switch ($interval) {
            case 5:{
                return $this->_5minData($baseCoinId, $tradeCoinId, $startTime, $endTime);
                break;
            }
            case 15:{
                return $this->_15minData($baseCoinId, $tradeCoinId, $startTime, $endTime);
                break;
            }
            case 30:{
                return $this->_30minData($baseCoinId, $tradeCoinId, $startTime, $endTime);
                break;
            }
            case 120:{
                return $this->_2hourData($baseCoinId, $tradeCoinId, $startTime, $endTime);
                break;
            }
            case 240:{
                return $this->_4hourData($baseCoinId, $tradeCoinId, $startTime, $endTime);
                break;
            }
            case 1440:{
                return $this->_1dayData($baseCoinId, $tradeCoinId, $startTime, $endTime);
                break;
            }
            default:
                return [];
    ...
    private function _5minData($baseCoinId, $tradeCoinId, $startTime, $endTime)
    {
        return $this->repository->getChartData(FiveMinute::class, $baseCoinId, $tradeCoinId, $startTime, $endTime);
    }

    private function _15minData($baseCoinId, $tradeCoinId, $startTime, $endTime)
    {
        return $this->repository->getChartData(FifteenMinute::class, $baseCoinId, $tradeCoinId, $startTime, $endTime);
    }

    private function _30minData($baseCoinId, $tradeCoinId, $startTime, $endTime)
    {
        return $this->repository->getChartData(ThirtyMinute::class, $baseCoinId, $tradeCoinId, $startTime, $endTime);
    }

    private function _2hourData($baseCoinId, $tradeCoinId, $startTime, $endTime)
    {
        return $this->repository->getChartData(TwoHour::class, $baseCoinId, $tradeCoinId, $startTime, $endTime);
    }

    private function _4hourData($baseCoinId, $tradeCoinId, $startTime, $endTime)
    {
        return $this->repository->getChartData(FourHour::class, $baseCoinId, $tradeCoinId, $startTime, $endTime);
    }

    private function _1dayData($baseCoinId, $tradeCoinId, $startTime, $endTime)
    {
        return $this->repository->getChartData(OneDay::class, $baseCoinId, $tradeCoinId, $startTime, $endTime);
    }
