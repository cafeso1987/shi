                        ...
                        <div class="row">
                            <div class="col-xl-12 mb-xl-0 mb-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="page_title" class="form-control-new" type="text" name="title" placeholder="{{__('Title')}}" @if(isset($cp))value="{{$cp->title}}" @else value="{{old('title')}}" @endif>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{__('Slug')}}</label>
                                            <input  type="text" class="form-control-new check_slug_validity" name="key" placeholder="{{__('Slug')}}" @if(isset($cp))value="{{$cp->key}}" @else value="{{old('key')}}" @endif>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{__('Type')}}</label>
                                            <select name="type" id="" class="form-control-new">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="10" name="" id="editor" class="form-control-new textarea note-editable" >@if(isset($cp)){!! clean($cp->description) !!} @else {{old('description')}} @endif</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
