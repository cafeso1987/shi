@extends('admin.master',['menu'=>'setting', 'sub_menu'=>'cookie'])
        ...
        <div class="row no-gutters">
            <div class="col-md-12 col-xl-12">
                ...
                <div class="profile-info-form">
                    <form action="{{route('adminCookieSettingsSave')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12 mt-20">
                                <div class="form-group">
                                    <label for="#">{{__('Cookie deccription')}} </label>
                                    <textarea class="form-control" name="" id="" rows="1">{{$settings['cookie_text'] ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6 col-12 mt-20">
                                <div class="form-group">
