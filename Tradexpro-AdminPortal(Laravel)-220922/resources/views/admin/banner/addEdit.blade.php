@extends('admin.master',['menu'=>'setting', 'sub_menu'=>'banner'])
                        ...
                        <div class="row">
                            <div class="col-xl-4 mb-xl-0 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control-new" @if(isset($item)) value="{{$item->title}}" @else value="{{old('title')}}" @endif>
                                </div>
                                <div class="form-group">
                                    <label>{{__('Activation Status')}}</label>
                                    <select name="status" class="form-control-new wide" >
                            ...
                            <div class="col-xl-8 mb-xl-0 mb-4">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" id="editor" class="form-control-new textarea note-editable" >@if(isset($item)){!! clean($item->description) !!}@else{{old('details')}}@endif</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
